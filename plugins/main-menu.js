 ...
 if (teks == 'edukasi') tags = {
  ...
  try {
      ...
      const sections = [
   {
	...
	rows: [
	    {title: `📛)ഒ Info Bot`, rowId: ".botinfo", description: "✧ Info nya 𝙕𝘼𝙇𝙇𝙭𝘽𝙊𝙏𝙕 ><"},
	...
	{title: `⚡)ഒ Speed`, rowId: ".speed", description: "✧ Kecepatan Respon 赤 𝙕𝘼𝙇𝙇𝙭𝘽𝙊𝙏𝙕..."},
	]
    },{
